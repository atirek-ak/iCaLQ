...
from utilities.constants import (k_factor_U1_interference,
                                 k_factor_U1_pair_production,
                                 k_factor_U1_pureqcd,
                                 k_factor_U1_single_production,
                                 k_factor_U1_t_channel, lhc_data_ee,
                                 lhc_data_HHbT, lhc_data_HHbV, lhc_data_LHbT,
                                 lhc_data_LHbV, lhc_data_mumu,
                                 pureqcd_contribution_mass_limit, quark_index,
                                 tag_names)
...
def calculateCouplingContribution(
    leptoquark_parameters: LeptoquarkParameters,
    coupling: str,
    symbolic_coupling: sym.Symbol,
    branching_fraction: sym.Symbol,
    cross_section: SingleCouplingCrossSections,
    efficiencies: SingleCouplingEfficiency,
) -> sym.Symbol:
    """
    ...
    denominator = [
        ...
        + leptoquark_parameters.systematic_error
        * leptoquark_parameters.systematic_error
        * nd_contribution[bin_number] ** 2
    ...
    for bin_number in range(number_of_bins):
        ...
        if leptoquark_parameters.mass <= pureqcd_contribution_mass_limit:
            pureqcd_contribution[bin_number] += (
                ...
                * efficiencies.efficiency_pureqcd[bin_number]
                * branching_fraction**2
                * leptoquark_parameters.luminosity
                * 1000
            )
        # pair production
        pair_production_contribution[bin_number] += (
            k_factor_pair_production
            * cross_section.cross_section_pair_production
            * efficiencies.efficiency_pair_production[bin_number]
            * symbolic_coupling**4
            * branching_fraction**2
            * leptoquark_parameters.luminosity
            * 1000
        )
        interference_contribution[bin_number] += (
            k_factor_interference
            * cross_section.cross_section_interference
            * efficiencies.efficiency_interference[bin_number]
            * symbolic_coupling**2
            * leptoquark_parameters.luminosity
            * 1000
        )
        tchannel_contribution[bin_number] += (
            k_factor_tchannel
            * cross_section.cross_section_tchannel
            * efficiencies.efficiency_tchannel[bin_number]
            * symbolic_coupling**4
            * leptoquark_parameters.luminosity
            * 1000
        )
        single_production_contribution[bin_number] += (
            k_factor_single_production
            * cross_section.cross_section_single_production
            * efficiencies.efficiency_single_production[bin_number]
            * symbolic_coupling**2
            * branching_fraction
            * leptoquark_parameters.luminosity
            * 1000
...
def calculateCouplingContributionCrossTerms(
    leptoquark_parameters: LeptoquarkParameters,
    coupling1: str,
    coupling2: str,
    symbolic_coupling1: sym.Symbol,
    symbolic_coupling2: sym.Symbol,
    cross_section: CrossTermsCrossSections,
    efficiencies: CrossTermsEfficiency,
) -> sym.Symbol:
    """
    Compute the chi-square polynomial for each coupling
    """
    ...
    # process wise contributions
    for bin_number in range(number_of_bins):
        cross_terms_tchannel_contribution[bin_number] += (
            k_factor_tchannel
            * cross_section.cross_terms_cross_section_tchannel
            * efficiencies.efficiency_tchannel[bin_number]
            * symbolic_coupling1**2
            * symbolic_coupling2**2
            * leptoquark_parameters.luminosity
            * 1000
        )
...
def calculateCouplingContributionTauTau(
    leptoquark_parameters: LeptoquarkParameters,
    coupling: str,
    symbolic_coupling: sym.Symbol,
    branching_fraction: sym.Symbol,
    cross_section: Union[SingleCouplingCrossSections, CrossTermsCrossSections],
    efficiencies: Union[SingleCouplingEfficiencyTauTau, CrossTermsEfficiencyTauTau],
) -> sym.Symbol:
    """
    Compute the chi-square polynomial for each coupling
    """
            ...
            if tag_name == "HHbT.csv":
                ...
                if (
                    ...
                    pureqcd_contribution[bin_number] += (
                        k_factor_pureqcd
                        * cross_section.cross_section_pureqcd
                        * efficiencies.efficiency_pureqcd.hhbt[bin_number]
                        * branching_fraction**2
                        * leptoquark_parameters.luminosity
                        * 1000
                    )
                pair_production_contribution[bin_number] += (
                    k_factor_pair_production
                    * cross_section.cross_section_pair_production
                    * efficiencies.efficiency_pair_production.hhbt[bin_number]
                    * symbolic_coupling**4
                    * branching_fraction**2
                    * leptoquark_parameters.luminosity
                    * 1000
                ...
                interference_contribution[bin_number] += (
                    k_factor_interference
                    * cross_section.cross_section_interference
                    * efficiencies.efficiency_interference.hhbt[bin_number]
                    * symbolic_coupling**2
                    * leptoquark_parameters.luminosity
                    * 1000
                )
                tchannel_contribution[bin_number] += (
                    k_factor_tchannel
                    * cross_section.cross_section_tchannel
                    * efficiencies.efficiency_tchannel.hhbt[bin_number]
                    * symbolic_coupling**4
                    * leptoquark_parameters.luminosity
                    * 1000
                )
                single_production_contribution[bin_number] += (
                    k_factor_single_production
                    * cross_section.cross_section_single_production
                    * efficiencies.efficiency_single_production.hhbt[bin_number]
                    * symbolic_coupling**2
                    * branching_fraction
                    * leptoquark_parameters.luminosity
                    * 1000
                ...
                if (
                    ...
                    pureqcd_contribution[bin_number] += (
                        k_factor_pureqcd
                        * cross_section.cross_section_pureqcd
                        * efficiencies.efficiency_pureqcd.hhbv[bin_number]
                        * branching_fraction**2
                        * leptoquark_parameters.luminosity
                        * 1000
                    )
                pair_production_contribution[bin_number] += (
                    k_factor_pair_production
                    * cross_section.cross_section_pair_production
                    * efficiencies.efficiency_pair_production.hhbv[bin_number]
                    * symbolic_coupling**4
                    * branching_fraction**2
                    * leptoquark_parameters.luminosity
                    * 1000
                ...
                interference_contribution[bin_number] += (
                    k_factor_interference
                    * cross_section.cross_section_interference
                    * efficiencies.efficiency_interference.hhbv[bin_number]
                    * symbolic_coupling**2
                    * leptoquark_parameters.luminosity
                    * 1000
                )
                tchannel_contribution[bin_number] += (
                    k_factor_tchannel
                    * cross_section.cross_section_tchannel
                    * efficiencies.efficiency_tchannel.hhbv[bin_number]
                    * symbolic_coupling**4
                    * leptoquark_parameters.luminosity
                    * 1000
                )
                single_production_contribution[bin_number] += (
                    k_factor_single_production
                    * cross_section.cross_section_single_production
                    * efficiencies.efficiency_single_production.hhbv[bin_number]
                    * symbolic_coupling**2
                    * branching_fraction
                    * leptoquark_parameters.luminosity
                    * 1000
                ...
                if (
                    ...
                    pureqcd_contribution[bin_number] += (
                        k_factor_pureqcd
                        * cross_section.cross_section_pureqcd
                        * efficiencies.efficiency_pureqcd.lhbt[bin_number]
                        * branching_fraction**2
                        * leptoquark_parameters.luminosity
                        * 1000
                    )
                pair_production_contribution[bin_number] += (
                    k_factor_pair_production
                    * cross_section.cross_section_pair_production
                    * efficiencies.efficiency_pair_production.lhbt[bin_number]
                    * symbolic_coupling**4
                    * branching_fraction**2
                    * leptoquark_parameters.luminosity
                    * 1000
                ...
                interference_contribution[bin_number] += (
                    k_factor_interference
                    * cross_section.cross_section_interference
                    * efficiencies.efficiency_interference.lhbt[bin_number]
                    * symbolic_coupling**2
                    * leptoquark_parameters.luminosity
                    * 1000
                )
                tchannel_contribution[bin_number] += (
                    k_factor_tchannel
                    * cross_section.cross_section_tchannel
                    * efficiencies.efficiency_tchannel.lhbt[bin_number]
                    * symbolic_coupling**4
                    * leptoquark_parameters.luminosity
                    * 1000
                )
                single_production_contribution[bin_number] += (
                    k_factor_single_production
                    * cross_section.cross_section_single_production
                    * efficiencies.efficiency_single_production.lhbt[bin_number]
                    * symbolic_coupling**2
                    * branching_fraction
                    * leptoquark_parameters.luminosity
                    * 1000
                ...
                if (
                    ...
                    pureqcd_contribution[bin_number] += (
                        k_factor_pureqcd
                        * cross_section.cross_section_pureqcd
                        * efficiencies.efficiency_pureqcd.lhbv[bin_number]
                        * branching_fraction**2
                        * leptoquark_parameters.luminosity
                        * 1000
                    )
                pair_production_contribution[bin_number] += (
                    k_factor_pair_production
                    * cross_section.cross_section_pair_production
                    * efficiencies.efficiency_pair_production.lhbv[bin_number]
                    * symbolic_coupling**4
                    * branching_fraction**2
                    * leptoquark_parameters.luminosity
                    * 1000
                ...
                interference_contribution[bin_number] += (
                    k_factor_interference
                    * cross_section.cross_section_interference
                    * efficiencies.efficiency_interference.lhbv[bin_number]
                    * symbolic_coupling**2
                    * leptoquark_parameters.luminosity
                    * 1000
                )
                tchannel_contribution[bin_number] += (
                    k_factor_tchannel
                    * cross_section.cross_section_tchannel
                    * efficiencies.efficiency_tchannel.lhbv[bin_number]
                    * symbolic_coupling**4
                    * leptoquark_parameters.luminosity
                    * 1000
                )
                single_production_contribution[bin_number] += (
                    k_factor_single_production
                    * cross_section.cross_section_single_production
                    * efficiencies.efficiency_single_production.lhbv[bin_number]
                    * symbolic_coupling**2
                    * branching_fraction
                    * leptoquark_parameters.luminosity
                    * 1000
...
def calculateCouplingContributionTauTauCrossTerms(
    leptoquark_parameters: LeptoquarkParameters,
    coupling1: str,
    coupling2: str,
    symbolic_coupling1: sym.Symbol,
    symbolic_coupling2: sym.Symbol,
    cross_section: CrossTermsCrossSections,
    efficiencies: CrossTermsEfficiencyTauTau,
) -> sym.Symbol:
    """
    Compute the chi-square polynomial for each coupling
    """
...
def getChiSquareSymbolic(
    ...
    for (
        coupling,
        symbolic_coupling,
    ) in zip(leptoquark_parameters.sorted_couplings, symbolic_couplings):
        if coupling[quark_index] == "3":
            chi_square = chi_square + calculateCouplingContributionTauTau(
                ...
                symbolic_coupling,
                branching_fraction,
                coupling_to_process_cross_section_map[coupling],
                coupling_to_process_efficiencies_map[coupling],
            )
        else:
    ...
    for i in range(len(leptoquark_parameters.sorted_couplings)):
        for j in range(i + 1, len(leptoquark_parameters.sorted_couplings)):
            ...
            if (
                leptoquark_parameters.sorted_couplings[i][quark_index]
                ...
                if coupling[quark_index] == "3":
                    chi_square = (
                        chi_square
                        + calculateCouplingContributionTauTauCrossTerms(
                            leptoquark_parameters,
                            leptoquark_parameters.sorted_couplings[i],
                            leptoquark_parameters.sorted_couplings[j],
                            symbolic_couplings[i],
                            symbolic_couplings[j],
                            coupling_to_process_cross_section_map[cross_terms_coupling],
